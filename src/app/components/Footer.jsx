                ...
                <div className="footerElements">
                    ...
                    <div className="navItemFooter">
                        <ul className="navelementFooter">
                            ...
                            <li className="navElFooter"><NavLink to="/services" activeClassName={s.active}> Services</NavLink></li>
                            <li className="navElFooter"><NavLink to="/team" activeClassName={s.active}> Team</NavLink></li>
                            <li className="navElFooter"><NavLink to="/contactus" activeClassName={s.active}> Contact Us</NavLink></li>
                        </ul>
                    </div>
                    <div className="footerEnd">
                        <p className="footerEndparagraph">© Movie 2019.  All Right Reserved.</p>
                    </div>
